...
pub const MESSAGE_SIGNUP_DATA_IN_BODY_FAILED: &str = "error when signing up, please check the values specified in 'data'";
pub const MESSAGE_LOGIN_SUCCESS: &str = "login successfully";
pub const MESSAGE_LOGIN_FAILED: &str = "wrong password, please try again";
